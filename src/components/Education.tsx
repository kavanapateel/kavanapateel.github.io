  ...
  return (
    <section id="education" className="education">
      ...
      <div className="sub-section">
        <div id="mca">
          <h2>
            MCA <span>2022 - 2024</span>
          </h2>
          <h3>
            <span>7.45 </span>CGPA
          </h3>
          <p>
            Institution: <span className="clg_loc">AIMIT, Beeri</span>
          </p>
          <iframe
        ...
        <div id="puc">
          <h2>
            12th <span>2017 - 2019</span>
          </h2>
          <h3>
            <span>61.16</span>%
          </h3>
          <p>
            Institution: <span className="clg_loc">Sharada PU College</span>
          </p>
          <iframe
